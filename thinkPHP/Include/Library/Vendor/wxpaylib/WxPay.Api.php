...
class WxPayApi
{
    ...
    public static function unifiedOrder($inputObj, $timeOut = 6)
    {
        ...
        // 	$inputObj->SetNotify_url(WxPayConfig_NOTIFY_URL);//异步通知url
        // }
    ...
    {
        //如果不需要上报数据
        if (WxPayConfig_REPORT_LEVENL == 0) {
            return;
        }
        //如果仅失败上报
        if (WxPayConfig_REPORT_LEVENL == 1 &&
    ...
    private static function postXmlCurl($xml, $url, $useCert = false, $second = 30)
    {
        ...
        if ($useCert == true) {
            ...
            curl_setopt($ch, CURLOPT_SSLCERT, WX_CERT_PATH . WxPayConfig_SSLCERT_PATH);
            curl_setopt($ch, CURLOPT_SSLKEYTYPE, 'PEM');
            curl_setopt($ch, CURLOPT_SSLKEY, WX_CERT_PATH . WxPayConfig_SSLKEY_PATH);
            /*2018-03-06后不再需要CA证书*/
            //curl_setopt($ch,CURLOPT_CAINFO,dirname(__FILE__).'/../../'.WxPayConfig::$CNTROOTCA_PATH);
