...
class Rbac
{
    ...
    static function saveAccessList($authId = null)
    {
        ...
        // 对管理员开发所有权限
        // hjun 2018-03-29 15:02:38 存入session时使用前缀
    ...
    //检查当前操作是否需要认证
    static function checkAccess($controller = null, $action = null)
    {
    ...
    //权限认证的过滤器方法
    static public function AccessDecision($appName = MODULE_NAME, $controller = null, $action = null)
    {
        //检查是否需要认证
        $controllerName = CONTROLLER_NAME;
        $actionName = ACTION_NAME;
        ...
        if (self::checkAccess($controllerName, $actionName)) {
            //存在认证识别号，则进行进一步的访问决策
            ...
            if (empty($super)) {
                ...
                // hjun 2018-03-29 15:01:43 存入session时使用前缀
